...
import '../../View/Screen/Auth/selection/controller/selection_controller.dart';
import '../../View/Screen/Auth/qualification/controller/qualification_management_controller.dart';
...
class DependencyInjection extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut(() => QualificationManagementController(), fenix: true);
