...
class TournamentsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Retrieve the same HomeController instance
    ...
    return Scaffold(
      ...
      body: Obx(() {
        // Filter events specifically for 'Tournaments' and match search query
        final tournaments = homeController.events.where((event) {
          final isTournament = event.category == 'Tournaments';
          ...
          return isTournament && matchesSearch;
        }).toList();
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _buildTournamentItem(event);
          },
        );
      }),
    );
  ...
  Widget _buildTournamentItem(EventModel event) {
